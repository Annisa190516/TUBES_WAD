...
<ul id="dropdown-menu" class="dropdown-content left-align">
  <li><a class="modal-trigger" href="{{route('admin.kelas.tugas_detail')}}">Detail</a></li>
...
<div id="modal-hapus" class="modal small">
  <form action="" method="">
    ...
    <div class="modal-content">
      ...
      <h6>Anda akan menghapus Tugas ... dari kelas ...</h6>
    ...
    <form action="" method="">
      ...
      <div class="row">
        ...
        <div class="col s12 m12 l3">
          <div class="input-field col s12">
           <input placeholder="" type="date" id="tanggal" class="validate" name="judul" required="">
           <label for="tanggal">Tanggal Deadline</label>
         </div>
         <div class="input-field col s12">
           <input placeholder="" type="time" id="waktu" class="validate" name="judul" required="">
