        ...
        <div style="margin: 2rem 0">
          <div class="row nm">
            <div class="col s12 m12 l6">
              <div class="row nm">
                <div class="col s3">
                  <i class="material-icons red-text text-lighten-5" style="font-size: 11px; padding-right: 4px">lens</i>10
                </div>
                <div class="col s3">
                  <i class="material-icons green-text text-lighten-5" style="font-size: 11px; padding-right: 4px">lens</i>12
                </div>
                <div class="col s3">
                  <i class="material-icons blue-grey-text text-lighten-5" style="font-size: 11px; padding-right: 4px">lens</i>13
                </div>
              </div>
            </div>
            <div class="col s12 m12 l6 right-align">
              <a href="#!" data-target="dropdown-rekap" class="waves-effect waves-light btn outlined primary dropdown-trigger"><i class="material-icons left">description</i>Rekap</a>
            </div>
          </div>
        </div>
        ...
        <table id="tabel-siswa" class="display">
          ...
          <tbody>
            <tr class="green lighten-5">
              ...
              <td>Sudah</td>
              <td>100</td>
              <td><a class="waves-effect waves-light btn outlined modal-trigger" href="#modal-jawaban">Jawaban</a></td>
            </tr>
...
<div id="modal-jawaban" class="modal modal-full">
  <div class="modal-header row">
    <div class="col s11">
      <h5>Jawaban Tugas Apa</h5>
      <h6>Nama Siswa | 12 juni 2020</h6>
    </div>
